...
var HomeTask = (function (_super) {
    ...
    return HomeTask;
}(Task)); //extends keyword is used to inherit from parent class Task
var HobbyTask = (function (_super) {
    __extends(HobbyTask, _super);
    function HobbyTask(description) {
        _super.call(this, description, "low"); // use super() when you want to modify methods inherited from parent class. In this case vale of property "priority"
        this.description = description;
    }
    return HobbyTask;
}(Task));
