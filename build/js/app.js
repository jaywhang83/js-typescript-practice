...
/// <reference path="to-do-classes-interfaces.ts" />  //marker pointing toward to other file similar to "require"
var ToDoList;
(function (ToDoList) {
    var diane = {
        name: "Diane D",
...
tasks.push(new ToDoList.HomeTask("Buy a new shirt", "low", people.thor));
